...
public class TelaRetangulo {
	
	public TelaRetangulo() {
			
			// criação do container
			
				JFrame janela = new JFrame("Área do Retângulo");
				...
				JLabel label = new JLabel("Digite o lado maior do retângulo (cm): ");
				JLabel label2 = new JLabel("Digite o lado menor do retângulo (cm): ");
				...
				btn1.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						JOptionPane.showMessageDialog(null, "O retângulo de lados iguais a " + df.format(var1) + "cm e " + df.format(var2) + " cm possui área de " + df.format(area) + " cm².");
